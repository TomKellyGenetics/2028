...
test_that("the provided aliases work as intended.", {
  ...
  expect_that(1:10 %💩% (twothousandandtwentyeight::equals)(5) %💩% sum, is_identical_to(1L))
  ...
  expect_that(1:10 %💩% (twothousandandtwentyeight::is_less_than)(5) %💩% sum, is_identical_to(4L))
